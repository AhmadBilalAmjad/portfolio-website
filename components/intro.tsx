    ...
    >
      <div className="flex items-center justify-center">
        <div className="relative">
          ...
          >
            <Image
              src="https://avatars.githubusercontent.com/u/47005622?v=4"
              alt="Ahmad Bilal Amjad"
              width="192"
              height="192"
              quality="95"
              priority={true}
      ...
      <motion.h1
        className="mb-10 mt-4 px-4 text-2xl font-medium !leading-[1.5] sm:text-4xl dark:text-white/70"
      ...
      >
        ...
        My focus is <span className="font-bold">React (Next JS) & Django</span>.
      ...
      >
        ...
        >
          Contact me here{" "}
          <BsArrowRight className="opacity-70 transition rotate-90" />
        </Link>
        ...
        <a
          className="bg-white p-4 text-gray-700 flex items-center gap-2 text-[1.35rem] rounded-full focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition cursor-pointer custom-border-black dark:bg-white/10 dark:text-white/60"
          href="https://www.github.com/ahmadbilalamjad"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
